...
public class Calculator extends JFrame
{
	...
	private static JButton btnKomma;
	...
	public JTextField getTxtIngave() {
		return txtIngave;
	}

	public void setTxtIngave(JTextField txtIngave) {
		this.txtIngave = txtIngave;
	}

	public static JButton getBtnKomma() {
		return btnKomma;
	}

	public static void setBtnKomma(JButton btnKomma) {
		Calculator.btnKomma = btnKomma;
	}
	...
	public Calculator()
	{
		...
		setBtnKomma(new JButton("."));
		getBtnKomma().setBackground(Color.LIGHT_GRAY);
		getBtnKomma().addActionListener(handlerEvents);
		pnlCenter.add(btnEenTerug);
		pnlCenter.add(btnNegen);
		pnlCenter.add(getBtnKomma());
		...
		setTxtIngave(new JTextField());
		getTxtIngave().setHorizontalAlignment(JTextField.RIGHT);
		getTxtIngave().setEditable(false);
		getTxtIngave().setToolTipText("Waarde die ingegeven wordt");
		pnlNoord.add(getTxtIngave(), BorderLayout.SOUTH);
