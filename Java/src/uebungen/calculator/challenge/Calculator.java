...
package uebungen.calculator.challenge;
	...
	private class GetActionCommandHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			try
			{
				...
				{
					if(!(txtIngave.getText().equals("") || txtIngave.getText().equals(".") || txtIngave.getText().equals("-") || txtIngave.getText().equals("-.")))
					{
						ingave.add(getInvoerZonderNul(txtIngave.getText()));				//Laatst ingegeven getal nog in de ArrayList plaatsen
						setTotaleBerekening();
						uitkomst = Double.parseDouble(ingave.get(0));	//Zorgen dat ook met het 1ste getal gerekend wordt
				...
				{
					if(!(txtIngave.getText().equals("") || txtIngave.getText().equals(".") || txtIngave.getText().equals("-") || txtIngave.getText().equals("-.")))	//Enkel een '.' wordt gezien als fout
					{
