...
public class Calculator_Main
{
	 public static void main( String[] args )
	 {
		 try
		 {
			 ...
			 // Site meer info: http://docs.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html
			 ...
			 rekenmachine.setLocationRelativeTo(null);		//Ervoor zorgen dat de JFrame in het midden van de scherm komt te staan
